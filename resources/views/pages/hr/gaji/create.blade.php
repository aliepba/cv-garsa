        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="jenis_pekerjaan" name="jenis_pekerjaan" value="{{$jenis_pekerjaan}}" hidden>
                  </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="jumlah_korosok">Korosok K</label>
          ...
          <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="total_absen">Total Gaji</label>
                        <input type="number" class="form-control" id="total_absen" name="total_gaji" value="">
                    </div>
                </div>
            </div>
...
<script>
    ...
    function sum() {
      ...
      var result = parseInt(totalKorosok) + parseInt(totalPk40) + parseInt(totalPkk20) + parseInt(totalPkk40);
      if (!isNaN(result)) {
