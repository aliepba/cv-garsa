          ...
          <div class="row">
            ...
            <div class="col-12">
              <table class="table-receipt">
                ...
                <tr>
                  <td>
                    <span class="d-block little-td">sales</span>
                    <span class="d-block font-weight-bold">{{ $transaksi->sales }}</span>
                  </td>
                  <td>
              ...
              <tr>
                  <td>
                    <div class="input-group">
                      <input type="text" class="form-control text-input input-notzero pelanggan-input" name="pelanggan" placeholder="Masukkan Nama Pelanggan">
                    </div>
                  </td>
                </tr>
                <tr>
