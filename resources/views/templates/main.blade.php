...
<html lang="en">
  ...
  @endif
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="kelola_barang">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{ url('/product') }}">Stok Barang</a>
                  </li>
                  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="collapse" href="#kelola_laporan" aria-expanded="false" aria-controls="kelola_laporan">
      <span class="menu-title">Master Penggajian</span>
      <i class="menu-arrow"></i>
    </a>
    <div class="collapse" id="kelola_laporan">
      <ul class="nav flex-column sub-menu">
        <li class="nav-item">
          <a class="nav-link" href="{{ route('upah.index')  }}">List Upah</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ route('absen.index') }}">Absensi</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ route('schedule.index') }}">Schedule</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="{{ route('penggajian.index') }}">Gaji</a>
        </li>
      </ul>
    </div>
  </li>
        ...
        <div class="main-panel">
          ...
          <footer class="footer" id="footer-content">
            <div class="container-fluid clearfix">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">©<a href="http://www.bootstrapdash.com/" target="_blank">Meisya Resti Garsari</a>. CV GARSA SEJAHTERA</span>
