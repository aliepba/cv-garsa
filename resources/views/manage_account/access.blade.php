        	...
        	<div class="col-12 table-responsive">
              ...
              <thead>
                <tr>
                  ...
                  <th class="text-center b-left">Data Karyawan</th> <!-- Add -->
                  <th class="text-center b-left">Master Penggajian</th> <!-- Add -->
                  <th class="text-center b-left">Pinjaman</th> <!-- Add -->
                </tr>
              </thead>
              <tbody>
                @foreach($access as $user)
                  ...
                  <td class="text-center b-left" data-access="kelola_laporan" data-user="{{ $user->user }}" data-role="{{ $user->role }}">
                    ...
                    <!-- Addd start -->
                  <td class="text-center b-left" data-access="data_karyawan" data-user="{{ $user->user }}" data-role="{{ $user->role }}">
                    @if($user->data_karyawan == 1)
                    <div class="btn-checkbox btn-access">
                        <i class="mdi mdi-checkbox-marked"></i>
                    </div>
                    @else
                  ...
                  <td class="text-center b-left" data-access="master_penggajian" data-user="{{ $user->user }}" data-role="{{ $user->role }}">
                    @if($user->master_penggajian == 1)
                    <div class="btn-checkbox btn-access">
                        <i class="mdi mdi-checkbox-marked"></i>
                    </div>
                    @else
                  ...
                  <td class="text-center b-left" data-access="pinjaman" data-user="{{ $user->user }}" data-role="{{ $user->role }}">
                    @if($user->pinjaman == 1)
                    <div class="btn-checkbox btn-access">
                        <i class="mdi mdi-checkbox-marked"></i>
                    </div>
