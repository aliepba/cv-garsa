          ...
          <div class="modal-body">
            <div class="form-group row">
              <div class="col-12">
                ...
                <div class="form-group row">
                  <label class="col-lg-3 col-md-3 col-sm-4 col-12 col-form-label font-weight-bold">Title Toko</label>
                  <div class="col-lg-9 col-md-9 col-sm-8 col-12">
                    <input type="text" class="form-control" name="no_telp" placeholder="Masukkan Title Toko" value="{{ $market->title }}">
                  </div>
                  <div class="col-lg-9 col-md-9 col-sm-8 col-12 offset-lg-3 offset-md-3 offset-sm-4 error-notice" id="title_error"></div>
                </div>
                <div class="form-group row">
              ...
              <div class="d-flex justify-content-between">
                <div class="d-flex justify-content-start">
                  ...
                  <div class="ml-2">
                    ...
                    <p class="des-transaksi">Rp. {{ number_format($ket_transaksi->total,2,',','.') }} <span class="dot"><i class="mdi mdi-checkbox-blank-circle"></i></span> {{ $ket_transaksi->sales }}</p>
                  </div>
                </div>
